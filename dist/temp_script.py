...
input_dir = os.path.dirname(r'W:\godot\cassiopeia\cas-data-designer\dist\origin.xlsx')
output_dir = os.path.dirname(r'W:\godot\cassiopeia\cas-data-designer\dist\origin.xlsx')
wb_file_path = r'W:\godot\cassiopeia\cas-data-designer\dist\origin.xlsx'
if wb_file_path.endswith('.xlsx') or wb_file_path.endswith('.xls'):
